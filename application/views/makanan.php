<div class="container-fluid">
    ...
    <?php foreach($makanan as $mkn) : ?>
        ...
        <div class="card-body">
            <h5 class="card-title mb-1"><?php echo $mkn->nama_brg?></h5>
            ...
            <?php echo anchor('dashboard/tambah_ke_keranjang/'.$mkn->id_brg,'<div class="btn btn-sm btn-primary">Tambah Ke Keranjang</div>') ?>
            <?php echo anchor('dashboard/detail/'.$mkn->id_brg,'<div class="btn btn-sm btn-success">Detail</div>') ?>
